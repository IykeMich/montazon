...
export default function Header() {
    return (
        <header className="bg-black text-white">
            <div className="px-2">
                <div className="flex items-center justify-between">
                    <div className="flex items-center">
                        <Link href='/' className="flex items-center header-button font-extrabold
                        text-2xl m-1"> 
                            <Image src='/icons/logo.svg' width={40} height={40} alt={`${APP_NAME} logo`} />
                            {APP_NAME}
                        </Link>
                    </div>
                    <div className="hidden:block flex-1 max-w-xl">
                        <Search />
                    </div>
                    <Menu />
                </div>
            ...
            <div className="dark flex items-center px-3 bg-gray-800 mb-[1px]">
