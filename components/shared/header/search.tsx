...
export default async function Search() {
    return (
        <form action="/search" method='GET' className='flex items-start h-10'>
            <Select name='category'>
                <SelectTrigger className='w-auto h-full dark:border-gray-100
            ...
            <Input className='flex-1 rounded-none dark:border-gray-200 bg-gray-100 text-base h-full'
